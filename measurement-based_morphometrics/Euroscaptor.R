...
# ===============================================================================
# Morphometric Analysis for Euroscaptor
# ===============================================================================
# This script performs Principal Component Analysis (PCA) and Canonical Variate
# Analysis (CVA) on craniomandibular morphometric data for Euroscaptor species.
# ===============================================================================
...
cva_plot <- ggplot(df, aes(x = CV1, y = CV2, color = species)) +
  ...
  theme_minimal() +
  labs(
    title = expression("CVA of " * italic("Euroscaptor") * " species - craniomandibular variables"),

...
inpath <- file.path("./Hidden-diversity-talpid-moles_supplemnt-material/geometric morphometrics/Parascaptor_V_JPG")

# Output directory for separated individual specimens
outpath <- file.path("./Hidden-diversity-talpid-moles_supplemnt-material/geometric morphometrics/Parascaptor_V_JPG_OUT")
...
inpath <- file.path("./Hidden-diversity-talpid-moles_supplemnt-material/geometric morphometrics/Euroscaptor_V_JPG")
# Output directory for processed individual specimens
outpath <- file.path("./Hidden-diversity-talpid-moles_supplemnt-material/geometric morphometrics/Euroscaptor_V_JPG_OUT")
